...
data-bs-theme="dark">
<div class="container">
    <a class="navbar-brand fw-light" href="/"><span class="fas fa-brain me-1"> </span>
    {{config('app.name')}}</a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
            ...
            @endif
            <li class="nav-item">
                <a class="{{ (Route::is('profiles.show')) ? 'active' : ''}} nav-link"  href="{{ route('profiles.show', Auth::user()->id) }}">{{Auth::user()->name}}</a>
            </li>
